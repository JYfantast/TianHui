...
parser.add_argument('--model_type', type=str, default="chatglm3-6b",
                    help='"DeepSeek-R1-Distill-Qwen-7B","DeepSeek-R1-Distill-Qwen-14B","DeepSeek-R1-Distill-Qwen-32B",'
                         '"Qwen2.5-Math-7B","Qwen2.5-14B-Instruct","Qwen2.5-32B-Instruct","Qwen2.5-72B-Instruct",'
...
parser.add_argument('--question_type', type=str, default="choice",
...
if question_type == "choice":
    ...
    output_file_path = f"/data/1JY/5TCMChat/results2/choice/{model_type}/choice.{current_time}.result.csv"
    ...
    output_file_path = f"/data/1JY/5TCMChat/results2/recommend/{model_type}/recommend.{current_time}.result.csv"
    ...
    output_file_path = f"/data/1JY/5TCMChat/results2/RC/{model_type}/RC.{current_time}.result.csv"
    ...
    output_file_path = f"/data/1JY/5TCMChat/results2/QA/{model_type}/QA.{current_time}.result.csv"
    ...
    output_file_path = f"/data/1JY/5TCMChat/results2/pharmacological/{model_type}/pharmacological.{current_time}.result.csv"
    ...
    output_file_path = f"/data/1JY/5TCMChat/results2/NER/{model_type}/NER.{current_time}.result.csv"
    ...
    output_file_path = f"/data/1JY/5TCMChat/results2/MC/{model_type}/MC.{current_time}.result.csv"
    ...
    output_file_path = f"/data/1JY/5TCMChat/results2/instructions/{model_type}/instructions.{current_time}.result.csv"
    ...
    output_file_path = f"/data/1JY/5TCMChat/results2/chemical/{model_type}/chemical.{current_time}.result.csv"
    ...
    output_file_path = f"/data/1JY/5TCMChat/results2/acupoint/{model_type}/acupoint.{current_time}.result.csv"
    ...
    output_file_path = f"/data/1JY/5TCMChat/results2/title/{model_type}/title.{current_time}.result.csv"
else:
...
if model_type == "DeepSeek-R1-Distill-Qwen-7B":
    ...
    api_key = "sk-d6OtsL7bABzymAOkzRkXbDmtd0hu6Sjj2rYYWVqlrz1VbWAx"
    ...
    model_namepath = "o1"
    base_url = "https://api.openai99.top/v1"
    api_key = "sk-tv4tcZ8XWaW79hIPGuXq4y1BWnbsI2TfZ4aLnBAvOI8tGn1U"
elif model_type == "deepseek-r1":
    model_namepath = "deepseek-reasoner"
    base_url = "https://api.deepseek.com"
    api_key = "sk-05f3874294084d07a98c8ad2bf734067"
elif model_type == "deepseek-v3":
    model_namepath = "deepseek-chat"
    base_url = "https://api.deepseek.com"
    api_key = "sk-05f3874294084d07a98c8ad2bf734067"
#未修改
elif model_type == "our_model-7B":
    model_namepath = "/data/1JY/6.DeepseekFT/saves/Qwen2.5-Math-7B/merge.SFT/train.8.16.0.2.4"
...
def process_responses_chatglm3(model, tokenizer, system_prompt, user_input, rawdata, output_file_path):
    ...
    for i, input_text in enumerate(user_input):
        ...
        #     response = response[0]  # 选择第一个元素
        # elif isinstance(response, list):
        #     response = str(response)  # 将整个列表转换为字符串
